...
public class BluetoothService {
    ...
    private static final UUID MY_UUID_SECURE =
            UUID.fromString("2f3b0104-fcb0-4bcf-8dda-6b06390c3c1a");
    private static final UUID MY_UUID_INSECURE =
            UUID.fromString("2f3b0104-fcb0-4bcf-8dda-6b06390c3c1a"); // Normally, these are different
    ...
    // @param handler A Handler to send messagees back to the UI Activity
    ...
    public synchronized void start() {
        ...
        // This is where you would start a thread to listen, but I don't want to do that
    ...
    // @param device The BluetoothDevice that has been connectd
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        // This is where you would cancel the acceptThread
    ...
    // This is where the AcceptThread would go
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                // This is a blocking call and will onl return on a
